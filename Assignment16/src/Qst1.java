...
// return true if the value is tails or false otherwise
 ...
 public static void main(String[] args)
 {
    ...
    for (int i = 0; i < 10; i++)
    {
       ...
       //System.out.println(myCoin.isHeads());//method that returns true when the value is not tails
       System.out.println(myCoin.isTails());//method that returns true when the value is not heads
    }
 }
 }
