abstract class Book{
    String title;
    abstract protected void setTitle(String s);
    String getTitle(){
    	System.out.println("Get title value is "+title);
        return title;
    }
}
final class Myclass extends Book{
	@Override
...
public static void main(String[] args) {
	...
	mc.getTitle();
	mc.setTitle("A tale of two cities");
}
}
/*Abstract class:
...
class. It works as 
a base for subclasses.Following is an example of abstract class:
abstract class Book{
    String title;
